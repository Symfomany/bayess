 ...
 */
classifier.learn(
  "envoie un email à Julien sur le document de la sécurité",
  "email"
);

classifier.learn("envoie un email à Simon avec le document du client", "email");
classifier.learn(
  "envoie un email à Manu avec la pièce jointe de la réunion",
  "email"
);

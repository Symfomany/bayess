...
int main()
{
    ...
    while (testingfile)
    {
        ...
        if (classification == 1 && prediction == 1)
            confusion_matrix[0][0]++;
        else if (classification == 1 && prediction == -1)
    ...
    while (testingfilebinary)
    {
        ...
        string s;
        if (!getline(testingfilebinary, s))
            break;
